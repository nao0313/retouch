...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録できないとき' do
      ...
      it 'nameが12文字以上では登録できない' do
        @user.name = '1234567890123'
        @user.valid?
        expect(@user.errors.full_messages).to include("Name is too long (maximum is 12 characters)")
      end
